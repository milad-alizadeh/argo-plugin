...
| 4 — /argo:init + /argo:update rewrite | in progress | | cli init/doctor/update red→green (14 tests); skills/init/SKILL.md written; setup-claude deleted; remaining: update/setup-design + 5 skill path rewrites, step 18 grep |
