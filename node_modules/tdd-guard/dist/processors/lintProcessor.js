...
exports.processLintData = processLintData;
exports.formatLintDataForContext = formatLintDataForContext;
/**
 * Processes lint data into a presentable format for validation context
 */
function processLintData(lintData) {
    if (!lintData) {
        return {
            hasIssues: false,
 ...
 */
function formatLintDataForContext(processedLint) {
