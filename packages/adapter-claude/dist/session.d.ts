import type { Attempt, GateVerdict } from '@argohq/core';
/**
...
export declare function spawnFresh(api: SessionApi, params: {
    requires: Record<string, string>;
    skill: string;
    frame: string;
 ...
 */
export declare function spawnWarm(api: SessionApi, warmHandle: SessionHandle | null, params: {
    unit: string;
    requires: Record<string, string>;
    skill: string;
    frame: string;
 ...
 * FRESH gets. */
export declare function spawnRetry(api: SessionApi, params: {
    requires: Record<string, string>;
    skill: string;
    frame: string;
    verdict: GateVerdict;
