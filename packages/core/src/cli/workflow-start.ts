...
import { deriveInstanceKey, setActiveInstance, writeInstance, type StateOptions, type WorkflowInstance } from '../state.js'
 ...
 */
export function workflowStart(input: WorkflowStartInput, opts: StateOptions = {}): WorkflowStartResult {
