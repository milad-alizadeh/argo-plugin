 ...
 */
export declare function nonSemanticBindingViolation(variable: Variable, kitVariableKeys?: string[] | string | null, semanticCollectionName?: string): {
    rule: string;
    detail: string;
} | null;
/**
 ...
 */
export declare function retiredFileKeyBindingViolation(variable: Variable, retiredVariableKeys?: string[]): {
    rule: string;
    detail: string;
} | null;
/**
 ...
 */
export declare function kitPatchesConformanceViolations(modifiedNodes: {
    component: string;
    file: string;
