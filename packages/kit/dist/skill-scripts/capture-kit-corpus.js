...
if (import.meta.url === `file://${process.argv[1]}`) {
    ...
    if (recordIndex === -1 || outIndex === -1) {
        console.error('capture-kit-corpus: usage: argo design capture-kit-corpus --record \'{"pristine":[...],"inverse":{...},"semanticModes":[...]}\' --out <path>');
        process.exit(1);
    }
    let parsed;
    try {
...
//# sourceMappingURL=capture-kit-corpus.js.map