...
if (!screen || !wireframeNodeId || !figmaFileVersion) {
    console.error('extract-region-contract: usage: argo design extract-region-contract <tree.json|tree.xml|-> <screen> <wireframeNodeId> <figmaFileVersion>');
    process.exit(1);
}
...
//# sourceMappingURL=extract-region-contract.js.map