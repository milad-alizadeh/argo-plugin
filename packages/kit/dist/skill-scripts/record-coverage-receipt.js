...
if (import.meta.url === `file://${process.argv[1]}`) {
    ...
    if (!contractPath || !builtRegionsPath || !producedBy) {
        console.error('record-coverage-receipt: usage: argo design record-coverage-receipt <contract.json> <built-regions.json> <dispositions.json> <producedBy>');
        process.exit(1);
    }
...
//# sourceMappingURL=record-coverage-receipt.js.map