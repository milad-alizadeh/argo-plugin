...
import { compareColor, comparePxInteger, compareHugDimension, convertLineHeight, convertLetterSpacing, resolveBoxModel, } from '../design-kit/index.js';
                ...
                for (const mode of ['light', 'dark']) {
                    it(`${storyName} (${mode}) matches the committed spec for ${storyFile}`, async () => {
                        ...
                        if (boxModel.checkType === 'hug') {
                            const width = compareHugDimension(spec.width, rect.width, boxModel.tolerance ?? undefined);
...
//# sourceMappingURL=spec-diff.js.map