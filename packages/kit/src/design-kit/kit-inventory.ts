...
type Inventory = { components?: { name: string; aliases?: string[] }[] } | undefined
 ...
 */
export function findKitNameCollisions(
  componentNames: string[] | undefined,
  { inventory, registry, waivers = [] }: { inventory?: Inventory; registry?: Registry; waivers?: Waiver[] } = {}
): string[] {
  ...
  const registryComponents =
    registry?.components && typeof registry.components === 'object' ? (registry.components as Record<string, unknown>) : {}
