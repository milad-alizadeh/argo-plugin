...
export function createDesignRulesCheckGate(options) {
    const { readFigma, cwd = process.cwd(), recipe = 'shadcn-tailwind', semanticCollectionName = 'Semantic', additionalAllowedCollectionNames = TW_COLLECTION_FAMILY } = options;
    return {
...
//# sourceMappingURL=design-rules-check.js.map