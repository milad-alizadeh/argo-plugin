/**
 * `code-to-design` workflow spec (workflow-engine-phase1.md Slice 11, step
 * 34; design doc "Workflow matrices #6"): `drift-detect` → `patch-mirror` →
 ...
 * per the plan's "workflow no.3's mechanism, referenced not duplicated".
 */
import { defineWorkflow, registerWorkflow } from '@argohq/core';
export const codeToDesignSpec = defineWorkflow({
    name: 'code-to-design',
    stages: [
        {
            name: 'drift-detect',
...
registerWorkflow(codeToDesignSpec);
//# sourceMappingURL=code-to-design.js.map