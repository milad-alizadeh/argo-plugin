/**
 * `screen-create` workflow spec (workflow-engine-phase1.md Slice 11, step 29;
 * design doc "Workflow matrices #1"): PRD+grill+ASCII wireframe happen
 ...
 *
 * `missing-components` is cross-workflow dependency resolution ("Missing
 ...
 * core has no spawn-workflow spec field in phase 1, so this is ordinary
...
export const screenCreateSpec = defineWorkflow({
    name: 'screen-create',
    stages: [
        {
            name: 'brief',
        ...
        },
        {
            ...
            requires: ['brief'],
            allows: ['file-read', 'figma-read', 'workflow-start'],
            skill: 'design-screen',
            session: 'fresh'
        },
        {
...
registerWorkflow(screenCreateSpec);
//# sourceMappingURL=screen-create.js.map