/**
 * `screen-edit` workflow spec (workflow-engine-phase1.md Slice 11, step 32;
 * design doc "Workflow matrices #4"): `update-brief` → `targeted-edits` →
 * `review`.
 *
...
export const screenEditSpec = defineWorkflow({
    name: 'screen-edit',
    stages: [
        {
            name: 'update-brief',
...
registerWorkflow(screenEditSpec);
//# sourceMappingURL=screen-edit.js.map