/**
 * `component-create` workflow spec (workflow-engine-phase1.md Slice 11, step
 * 30; design doc "Workflow matrices #2"): `exists-check` → `build` →
...
export const componentCreateSpec = defineWorkflow({
...
registerWorkflow(componentCreateSpec)
