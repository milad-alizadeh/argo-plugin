 ...
 * nodes are exempt from design-rules (a screenshot can't satisfy binding rules) and
...
export const RegistryEntrySchema = z.object({
   ...
   * documented placeholder label. The design-rules `untraced-copy` rule accepts a
