...
describe('nonSemanticBindingViolation (starter-file model: local Semantic bindings only)', () => {
  ...
  // Regression: a stock kit duplicate deliberately splits tokens across a
  // tw/* collection family — without this allowlist the check hard-failed
  // every one of the kit's own untouched components.
