 ...
 * into the registry so the design-rules audit exempts the screen's own artboard from
...
annotation; this mirrors it into the registry (design-rules exempts a registered
