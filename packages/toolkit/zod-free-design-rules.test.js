...
/**
 * Council-mandated hard gate: the design-rules subpaths run inside the Figma
...
const SANDBOX_SUBPATHS = ['./design-kit/design-rules', './design-kit/shadcn-tailwind/design-rules']

describe('zod-free design-rules subpaths', () => {
