---
name: figma-audit
description: Run the canonical design-rules Figma hygiene audit against named components (hard gate) or the whole file (advisory sweep). Use when the user asks to audit, check, or lint the Figma file for design-pack hygiene, before figma-sync/design-component hand off to it internally, or after any Figma-side generation to confirm it's clean.
---

<!-- INCLUDE: packages/toolkit/packs/design/craft/figma-audit.md -->
