...
- **Never hand-edit a lockfile or hand-write a version.** Add, upgrade, or remove
  packages by running the project's package manager so the lockfile stays
  authoritative.
...
- Pin/track versions through the lockfile; let the manager resolve the tree.
