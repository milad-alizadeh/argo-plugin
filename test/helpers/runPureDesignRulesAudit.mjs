 ...
 * of `templates/design/design-rules-audit.js`'s walk/auditNode glue, over already-
 ...
 * shape the real walker produces (see design-rules-audit.js's own marshaling
 ...
 * (that stays exclusively in packages/figma-design-kit/design-rules.js).
 */
import {
...
} from '../../packages/toolkit/src/packs/design/design-kit/design-rules.js'
...
export function runPureDesignRulesAudit(nodes) {
  const violations = []
  const walk = (node) => {
